        ...
        <ScrollView showsVerticalScrollIndicator={false} style={styles.form}>
                ...
                <View style={styles.row}>
                  <View style={styles.content}>
                    {item.category == "Grain" ? (
                      ...
                      <View
                        style={[styles.logo, { backgroundColor: "#2FC6B7" }]}
                      >
                        <Dairy />
                      </View>
                    ) : item.category == "Produce" ? (
                      <View
                        style={[styles.logo, { backgroundColor: "#FF9F1C" }]}
                      >
                        <Fruit />
                      </View>
                    ) : (
                      <View
                        style={[styles.logo, { backgroundColor: "#FFBF69" }]}
                      >
                        <Meat />
                      </View>
                    )}
          ...
          <View style={styles.box}>
            ...
            <View style={styles.row}>
              <View style={styles.content}>
                <View
                  style={[styles.logo, { backgroundColor: "#E5E5E5" }]}
                ></View>
